...
void loop() {
  ...
  //Serial.print(cm);
  float speed_by_distance = map(cm, 0, 60, 60, 90);
...
//    if (drivingflag == 1 && ir_F==0){         //직진 중에 앞 ir 인식이 안되는 경우
//      digitalWrite(DIR1, HIGH);
//      analogWrite(PWM1, 90);
//      digitalWrite(DIR2,HIGH);
//      analogWrite(PWM2, 17);// 오른쪽으로 가는 코드
//      //Serial.println("ffffffff");
//      delay(100);
//    }
//    else if (drivingflag == 0 && ir_F==0){
//      digitalWrite(DIR1, HIGH);
//      analogWrite(PWM1, 17);
//      digitalWrite(DIR2, HIGH);
//      analogWrite(PWM2, 90); // 왼쪽으로 가는 코드
